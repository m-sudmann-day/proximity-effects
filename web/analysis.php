            ...
            if ($isPost && $selected_area_id != -1 && $selected_category_id != -1)
            {
                ...
                foreach(glob($files) as $file)
                {
                    if (!$atLeastOneFile)
                    {
                        ...
                        echo("Interpretation of the results is left to the reader.  The slopes and significances vary greatly between business categories and somewhat between geographies.  The title of each chart shows how many businesses are included in the analysis.<br /><br />");
                        $atLeastOneFile = TRUE;
                    }
                    echo("<tr><td>&nbsp;</td></tr>");
