...
install.packages("maps", repos="http://cran.r-project.org", lib="/home/ubuntu/projects/Rlibs/")
install.packages("shapefiles", repos="http://cran.r-project.org", lib="/home/ubuntu/projects/Rlibs/")
